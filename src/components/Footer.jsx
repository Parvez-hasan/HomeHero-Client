    ...
    <footer className="container mx-auto dark:bg-gray-800 bg-green-100  ">
      <div className="footer sm:footer-horizontal text-neutral-content justify-between p-10">
        <nav>
          ...
          <p className=" text-gray-700 dark:text-gray-100">We provide the best home repair <br />
              services with reliable care.</p>
        </nav>
        <nav>
          <h6 className="font-bold  text-gray-700 dark:text-gray-100 py-2">Service</h6>
          <a className="link  text-gray-700 dark:text-gray-100 link-hover">Door & Lock Repair</a>
          <a className="link  text-gray-700 dark:text-gray-100 link-hover">Electricians Near</a>
          <a className="link  text-gray-700 dark:text-gray-100 link-hover">Home Cleaning Services</a>
          <a className="link  text-gray-700 dark:text-gray-100 link-hover">Reliable Plumber</a>
          <a className="link  text-gray-700 dark:text-gray-100 link-hover">Painting Service</a>
          <a className="link  text-gray-700 dark:text-gray-100 link-hover">Home Repairs</a>
        </nav>
        <nav>
          <h6 className="font-bold dark:text-gray-100 text-gray-700 py-2">Contacts Us</h6>
          {/* location */}
         <div className="flex justify-center items-center">
          ...
          <div>
             <a className="link dark:text-gray-100 text-gray-700 link-hover">17 Arlington St, Kishoreganj, Bangladesh</a>
          </div>
         </div>
         {/* phone  */}
         <div className="flex justify-center items-center">
          ...
          <div>
             <a className="link dark:text-gray-100 text-gray-700 link-hover">+880 1948-017882</a>
          </div>
         </div>
        ...
        {/* gmail */}
         ...
         <div className="flex justify-center items-center">
          ...
          <div>
             <a className="link dark:text-gray-100 text-gray-700 link-hover">parvezweb.33@gmail.com</a>
          </div>
         </div>
